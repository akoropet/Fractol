...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/17 20:43:01 by akoropet          #+#    #+#             */
/*   Updated: 2019/09/17 19:42:03 by akoropet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calc_elvis(t_frac *frac, double x, double y)
{
	...
	{
		temp = -fabs((sqr_x * sqr_x) + (sqr_y * sqr_y) - (6 * sqr_x * sqr_y)) +
			frac->c_re;
		y = 4 * x * fabs(y) * (sqr_x - sqr_y) + frac->c_im;
		x = temp;
		sqr_x = x * x;
		sqr_y = y * y;
		iter++;
